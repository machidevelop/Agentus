...
interface ReviewsToolbarProps<TData extends RowData> {
  table: ReactTable<DataTableFeatures, TData>;
}

export function ReviewsToolbar<TData extends RowData>({ table }: ReviewsToolbarProps<TData>) {
