            ...
            <PaginationContent className="gap-1">
              <PaginationItem className="hidden lg:block">
                <PaginationLink
                  ...
                  onClick={(e) => { preventPaginationNavigation(e); if (canPreviousPage) table.setPageIndex(0); }}
                >
                  <ChevronsLeft />
                </PaginationLink>
              </PaginationItem>
              <PaginationItem>
                <PaginationPrevious
                  ...
                  aria-disabled={!canPreviousPage}
                  className={cn(!canPreviousPage && "pointer-events-none opacity-50")}
                  onClick={(e) => { preventPaginationNavigation(e); if (canPreviousPage) table.previousPage(); }}
                />
              </PaginationItem>
              ...
              {pageNumbers.map((pageNumber) => (
                <PaginationItem key={pageNumber}>
                  <PaginationLink
                    ...
                    onClick={(e) => { preventPaginationNavigation(e); table.setPageIndex(pageNumber - 1); }}
                  >
                    {pageNumber}
                  </PaginationLink>
                </PaginationItem>
              ...
              <PaginationItem>
                <PaginationNext
                  ...
                  onClick={(e) => { preventPaginationNavigation(e); if (canNextPage) table.nextPage(); }}
                />
              </PaginationItem>
              <PaginationItem className="hidden lg:block">
                <PaginationLink
                  ...
                  aria-disabled={!canNextPage}
                  className={cn(!canNextPage && "pointer-events-none opacity-50")}
                  onClick={(e) => { preventPaginationNavigation(e); if (canNextPage) table.setPageIndex(pageCount - 1); }}
                >
                  <ChevronsRight />
                </PaginationLink>
              </PaginationItem>
